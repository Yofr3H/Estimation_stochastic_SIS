...
begin
   slider_replications = @bind replications Slider(10000:10000:100000, default=50000,show_value=true)
...
begin
	...
	extrem_trajectorie = zeros(Time + 1,2)
	quantile_trajectorie = zeros(Time + 1,2)
	...
	for i = 1:(Time + 1)	
		...
		quantile_trajectorie[i,1] = quantile(dat,0.05) 
		quantile_trajectorie[i,2] = quantile(dat,0.95) 	
	end
	

		#plot simulation extrem 
		graf = Plots.plot(time_plot_trajectory, extrem_trajectorie[:,1],
			fillrange = extrem_trajectorie[:,2], fillalpha = 0.15, c = 1, 
			label = "Simulation band", legend = :topleft)
		#graf = Plots.plot(time_plot_trajectory,extrem_trajectorie[:,1],
		#color="black",label="min",lw=3)
		#plot!(graf,time_plot_trajectory,extrem_trajectorie[:,2],
		#color="black",label ="max",lw=3)
	...
	#plot!(graf,time_plot_trajectory,quantile_trajectorie[:,1],
		#color="blue",label="q 0.05",lw=3)
	#plot!(graf,time_plot_trajectory,quantile_trajectorie[:,2],
		#color="blue",label="q 0.95",lw=3)
	plot!(graf,time_plot_trajectory, quantile_trajectorie[:,1], 
		fillrange = quantile_trajectorie[:,2], fillalpha = 0.25,
		c = 1, label = "quantile band", legend = :topleft)
...
[[deps.ORCA]]
deps = ["PlotlyBase"]
git-tree-sha1 = "21116b7c215347f1759ebb013f89bce3cafb6b4f"
uuid = "47be7bcc-f1a6-5447-8b36-7eeeff7534fd"
version = "0.5.0"
...
git-tree-sha1 = "5eb8913f14a48db2f62ffad7a2e7f30bfd5e9396"
uuid = "a03496cd-edff-5a9b-9e67-9cda94a718b5"
version = "0.4.3"

[[deps.PlotlyJS]]
deps = ["Blink", "DelimitedFiles", "JSExpr", "JSON", "Markdown", "Pkg", "PlotlyBase", "REPL", "Reexport", "Requires", "WebIO"]
git-tree-sha1 = "882ec81d5cf7d32168946397652ead9df99e0346"
